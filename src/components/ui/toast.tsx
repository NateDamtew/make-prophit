...
interface ToastFunction {
  ...
  // Fork addition: delegates to the base-ui manager's promise helper. Keeps the
  // `toast.promise(p, { loading, success, error })` call shape the fork already
  // uses in ~9 places (carried over from sonner, which upstream dropped).
